...
const dbPath = path_1.default.resolve(env_1.env.DATABASE_PATH);
...
exports.sqlite.pragma('journal_mode = DELETE');
// Enforce foreign key constraints
exports.sqlite.pragma('foreign_keys = ON');
// Enable busy timeout to avoid SQLITE_BUSY errors
exports.sqlite.pragma('busy_timeout = 5000');
exports.db = (0, better_sqlite3_2.drizzle)(exports.sqlite, { schema });
